...
(defun set-sbt-invoke-commands (value) (puthash (buffer-name) value sbt-invoke-commands))
...
(defun set-sbt-invoke-cont (value) (puthash (buffer-name) value sbt-invoke-cont))
...
(defun set-sbt-invoke-status (value) (puthash (buffer-name) value sbt-invoke-status))
...
(defun set-sbt-invoke-steps (value) (puthash (buffer-name) value sbt-invoke-steps))
...
(defun set-sbt-invoke-next-step (value) (puthash (buffer-name) value sbt-invoke-next-step))
...
(defun set-sbt-invoke-output-callback (value) (puthash (buffer-name) value sbt-invoke-output-callback))
...
(defun sbt-invoke (buffer-name project-name commands &optional cont)
  ...
  (when (and buffer-name project-name)
    ...
    (set-sbt-invoke-steps commands)
    (cd (sbt-project-root (project-path (sbt-invoke-project))))
